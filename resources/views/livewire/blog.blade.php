			...
			<div class="col-lg-9">
				<div class="me-lg-4">
                    ...
                    @foreach($blogs as $blog)
						<div class="mb-5 col-md-6" data-aos="fade-up">
                            <article class="overflow-hidden bg-white border-0 shadow-sm blog-post rounded-3 h-100">
                                {{-- Post Image --}}
			...
			<div class="col-lg-3">
				...
				<div class="widget widget-categories">
					...
					<ul class="list-unstyled widget-list">
                        ...
                        <li class="mb-2"><a href="{{route('blog').'?categorySlug='.$category->slug}}">{{$category->name}}</a>
                        @endforeach
                        @endif
					</ul>
				</div>
						...
						<li class="d-flex widget-post align-items-center">
							<a class="text-black" href="{{route('blogDetail',$blog->id)}}">
								<div class="flex-shrink-0 widget-post-image me-3">
									<img class="rounded" loading="lazy" decoding="async" src="{{ asset('storage/' . $blog->image) }}" alt="Post Thumbnail">
								</div>
							</a>
							<div class="flex-grow-1">
								<h5 class="mb-0 h6"><a class="text-black" href="{{route('blogDetail',$blog->id)}}">{{$blog->title}}</a></h5>
